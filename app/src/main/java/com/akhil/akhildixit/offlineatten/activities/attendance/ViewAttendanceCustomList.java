...
public class ViewAttendanceCustomList extends BaseAdapter {

    Context context;
    ArrayList<Student> rollNumber;
    ...
    public ViewAttendanceCustomList(Context context, ArrayList<Student> rollNumber, ArrayList<Bitmap> bitmapArrayList)
    {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        roll.setText(rollNumber.get(position).rollnumber);
        nameT.setText(rollNumber.get(position).name);
        status.setText(rollNumber.get(position).status);
